...
*/}}
{{- define "auth-service.privateHostsList" -}}
{{- $hosts := list }}
{{- if and .Values.hosts.private.enabled (gt (len .Values.hosts.private.domains) 0) }}
{{- range .Values.hosts.private.domains }}
  {{- $hosts = append $hosts . }}
...
*/}}
{{- define "auth-service.publicHostsList" -}}
{{- $hosts := list }}
{{- if and .Values.hosts.public.enabled (gt (len .Values.hosts.public.domains) 0) }}
{{- range .Values.hosts.public.domains }}
  {{- $hosts = append $hosts . }}
...
*/}}
{{- define "auth-service.publicGatewayName" -}}
{{- if .Values.istio.gateway.public.name }}
{{- .Values.istio.gateway.public.name }}
{{- else }}
{{- include "auth-service.fullname" . }}-public-gateway
{{- end }}
{{- end }}
...
*/}}
{{- define "auth-service.privateGatewayName" -}}
{{- if .Values.istio.gateway.private.name }}
{{- .Values.istio.gateway.private.name }}
{{- else }}
{{- include "auth-service.fullname" . }}-private-gateway
{{- end }}
{{- end }}
...
*/}}
{{- define "auth-service.virtualServiceName" -}}
{{- include "auth-service.fullname" . }}-vs
{{- end }}

{{/*
Create DestinationRule name
*/}}
{{- define "auth-service.destinationRuleName" -}}
{{- include "auth-service.fullname" . }}-dr
{{- end }}

{{/*
Create ServiceMonitor name
*/}}
{{- define "auth-service.serviceMonitorName" -}}
{{- include "auth-service.fullname" . }}-metrics
{{- end }}
...
Gateway Name
*/}}
{{- define "auth-service.gateway" -}}
{{- printf "%s-gateway" (include "auth-service.fullname" .) }}
{{- end -}}

{{/*
VirtualService Name
*/}}
{{- define "auth-service.virtualservice" -}}
{{- printf "%s-vs" (include "auth-service.fullname" .) }}
{{- end -}}

{{/*
DestinationRule Name
*/}}
{{- define "auth-service.destinationrule" -}}
{{ printf "%s-dr" (include "auth-service.fullname" .) }}
{{- end -}}

{{/*
Gateway Labels
*/}}
{{- define "auth-service.gatewayLabels" -}}
{{- include "auth-service.labels" . }}
...
Gateway Annotations
*/}}
{{- define "auth-service.gatewayAnnotations" -}}
...
*/}}
{{- define "auth-service.commonGatewaySelector" -}}
...
*/}}
{{- define "auth-service.privateGatewaySelector" -}}
...
*/}}
{{- define "auth-service.publicGatewaySelector" -}}
{{- $hasCommon := .Values.istio.gateway.selector -}}
...
*/}}
{{- define "auth-service.waypointName" -}}
{{- printf "%s-waypoint" (include "auth-service.fullname" .) }}
{{- end -}}

{{/*
Ambient Mode Namespace Labels
*/}}
{{- define "auth-service.ambientNamespaceLabels" -}}
...
*/}}
{{- define "auth-service.sidecarAnnotations" -}}
