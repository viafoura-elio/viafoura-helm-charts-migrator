...
*/}}
{{- define "livechat.privateHostsList" -}}
{{- $hosts := list }}
{{- if and .Values.hosts.private.enabled (gt (len .Values.hosts.private.domains) 0) }}
{{- range .Values.hosts.private.domains }}
  {{- $hosts = append $hosts . }}
...
*/}}
{{- define "livechat.publicHostsList" -}}
{{- $hosts := list }}
{{- if and .Values.hosts.public.enabled (gt (len .Values.hosts.public.domains) 0) }}
{{- range .Values.hosts.public.domains }}
  {{- $hosts = append $hosts . }}
...
*/}}
{{- define "livechat.publicGatewayName" -}}
{{- if .Values.istio.gateway.public.name }}
{{- .Values.istio.gateway.public.name }}
{{- else }}
{{- include "livechat.fullname" . }}-public-gateway
{{- end }}
{{- end }}
...
*/}}
{{- define "livechat.privateGatewayName" -}}
{{- if .Values.istio.gateway.private.name }}
{{- .Values.istio.gateway.private.name }}
{{- else }}
{{- include "livechat.fullname" . }}-private-gateway
{{- end }}
{{- end }}
...
*/}}
{{- define "livechat.virtualServiceName" -}}
{{- include "livechat.fullname" . }}-vs
{{- end }}

{{/*
Create DestinationRule name
*/}}
{{- define "livechat.destinationRuleName" -}}
{{- include "livechat.fullname" . }}-dr
{{- end }}

{{/*
Create ServiceMonitor name
*/}}
{{- define "livechat.serviceMonitorName" -}}
{{- include "livechat.fullname" . }}-metrics
{{- end }}
...
Gateway Name
*/}}
{{- define "livechat.gateway" -}}
{{- printf "%s-gateway" (include "livechat.fullname" .) }}
{{- end -}}

{{/*
VirtualService Name
*/}}
{{- define "livechat.virtualservice" -}}
{{- printf "%s-vs" (include "livechat.fullname" .) }}
{{- end -}}

{{/*
DestinationRule Name
*/}}
{{- define "livechat.destinationrule" -}}
{{ printf "%s-dr" (include "livechat.fullname" .) }}
{{- end -}}

{{/*
Gateway Labels
*/}}
{{- define "livechat.gatewayLabels" -}}
{{- include "livechat.labels" . }}
...
Gateway Annotations
*/}}
{{- define "livechat.gatewayAnnotations" -}}
...
*/}}
{{- define "livechat.commonGatewaySelector" -}}
...
*/}}
{{- define "livechat.privateGatewaySelector" -}}
...
*/}}
{{- define "livechat.publicGatewaySelector" -}}
{{- $hasCommon := .Values.istio.gateway.selector -}}
...
*/}}
{{- define "livechat.waypointName" -}}
{{- printf "%s-waypoint" (include "livechat.fullname" .) }}
{{- end -}}

{{/*
Ambient Mode Namespace Labels
*/}}
{{- define "livechat.ambientNamespaceLabels" -}}
...
*/}}
{{- define "livechat.sidecarAnnotations" -}}
