...
*/}}
{{- define "base-chart.privateHostsList" -}}
{{- $hosts := list }}
{{- if and .Values.hosts.private.enabled (gt (len .Values.hosts.private.domains) 0) }}
{{- range .Values.hosts.private.domains }}
  {{- $hosts = append $hosts . }}
...
*/}}
{{- define "base-chart.publicHostsList" -}}
{{- $hosts := list }}
{{- if and .Values.hosts.public.enabled (gt (len .Values.hosts.public.domains) 0) }}
{{- range .Values.hosts.public.domains }}
  {{- $hosts = append $hosts . }}
...
*/}}
{{- define "base-chart.publicGatewayName" -}}
{{- if .Values.istio.gateway.public.name }}
{{- .Values.istio.gateway.public.name }}
{{- else }}
{{- include "base-chart.fullname" . }}-public-gateway
{{- end }}
{{- end }}
...
*/}}
{{- define "base-chart.privateGatewayName" -}}
{{- if .Values.istio.gateway.private.name }}
{{- .Values.istio.gateway.private.name }}
{{- else }}
{{- include "base-chart.fullname" . }}-private-gateway
{{- end }}
{{- end }}
...
*/}}
{{- define "base-chart.virtualServiceName" -}}
{{- include "base-chart.fullname" . }}-vs
{{- end }}

{{/*
Create DestinationRule name
*/}}
{{- define "base-chart.destinationRuleName" -}}
{{- include "base-chart.fullname" . }}-dr
{{- end }}
...
{{- include "base-chart.fullname" . }}-metrics
{{- end }}
...
Gateway Name
*/}}
{{- define "base-chart.gateway" -}}
{{- printf "%s-gateway" (include "base-chart.fullname" .) }}
{{- end -}}

{{/*
VirtualService Name
*/}}
{{- define "base-chart.virtualservice" -}}
{{- printf "%s-vs" (include "base-chart.fullname" .) }}
{{- end -}}

{{/*
DestinationRule Name
*/}}
{{- define "base-chart.destinationrule" -}}
{{ printf "%s-dr" (include "base-chart.fullname" .) }}
{{- end -}}

{{/*
Gateway Labels
*/}}
{{- define "base-chart.gatewayLabels" -}}
{{- include "base-chart.labels" . }}
...
Gateway Annotations
*/}}
{{- define "base-chart.gatewayAnnotations" -}}
...
*/}}
{{- define "base-chart.commonGatewaySelector" -}}
...
*/}}
{{- define "base-chart.privateGatewaySelector" -}}
...
*/}}
{{- define "base-chart.publicGatewaySelector" -}}
{{- $hasCommon := .Values.istio.gateway.selector -}}
...
*/}}
{{- define "base-chart.waypointName" -}}
{{- printf "%s-waypoint" (include "base-chart.fullname" .) }}
{{- end -}}

{{/*
Ambient Mode Namespace Labels
*/}}
{{- define "base-chart.ambientNamespaceLabels" -}}
...
*/}}
{{- define "base-chart.sidecarAnnotations" -}}
