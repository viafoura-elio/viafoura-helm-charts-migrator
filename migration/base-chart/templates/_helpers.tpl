...
{{- $saName := .Values.serviceAccount.name | trimSuffix "-sa" }}
{{- if .Values.serviceAccount.create }}
{{- default (printf "%s-sa" (include "base-chart.fullname" .)) $saName }}
{{- else }}
...
{{- else }}
{{- printf "%s.%s.pod" (include "base-chart.fullname" .) .Release.Namespace }}
{{- end }}
{{- end }}
